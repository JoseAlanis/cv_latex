...
github: JoseAlanis
linkedin: jcgalanis
aboutme: "Hi! I'm a experimental and clinical psychologist at the Philipps-Universität Marburg. My work lies at the interface between science and clinical practice, bridging basic research with the application of clincal interventions in the field. My research interests are focused on personal and situational influences on human brain function in relation to goal-directed behavior. I have a background in statistical modelling and scientific software development using **Python** (e.g., NumPy, Pandas, SciPy, scikit-learn), **R**, and **Git**.  I'm also an active member of the open source community and an advocate of open, reproducible, and robust scientific practices."
